        ...
        <div class="blog-view-container">
            <div class="latest">
                <article class="main-post">
                    ...
                    <div class="content-field">
                        ...
                        <div class="hygraph-html">{@html lastPost1.content.html}</div>
            ...
            <div class="blog2">
                <article class="main-post2">
                    ...
                    <div class="hygraph-html2">{@html lastPost2.content.html}</div>
            ...
            <div class="blog3">
                <article class="main-post3">
                    ...
                    <div class="content-field3">
                        ...
                        <span class="author3">Door {lastPost3.author} op {lastPost3.date}</span>
                    </div>

                    <h3>{lastPost3.title}</h3>

                    <div class="hygraph-html3">{@html lastPost3.content.html}</div>
                                ...
                                <a href="/post/{post.slug}">
                                    <li id="{post.slug}">
                                        ...
                                        <div class="blog-text">
                                            ...
                                            <p class="intro-text">
                                                Het is tijd om Nederlanders bewust te maken van de hoeveelheid regenwater op- en rondom het huis. Onze oplossing is het grootschalig inzetten
                                                vanmicro-maatregelen.
                                            </p>

                                            <a class="read-more-small" href="/post/{post.slug}"> <i class="fa fa-arrow-right" aria-hidden="true" /></a>
                                        </div>
                                    </li>
                                </a>
                                {/each}
