        ...
        <section class="home" id="home">
            <section class="parallax">
                ...
                <div id="text">
                    ...
                    <h3 class="home-scroll">scroll<span class="material-symbols-outlined">arrow_downward</span></h3>
                </div>
            ...
            <section class="parallax2">
                <img src="/Parallax2/city-full.png" id="city2" alt="city illustratie" />
                <img src="/Parallax2/water-full.png" id="water2" alt="water illustratie" />
                <img src="/Parallax2/berg4-full.png" id="layer1-2" alt="berg illustratie" />
                <img src="/Parallax2/berg3-full.png" id="layer2-2" alt="berg illustratie" />
                <img src="/Parallax2/berg2-full.png" id="layer3-2" alt="berg illustratie" />
                <img src="/Parallax2/huisje-full.png" id="layer4-2" alt="huis illustratie" />
                <img src="/Parallax2/berg1-full.png" id="layer5-2" alt="berg illustratie" />
                <div id="text2">
                ...
                <img src="/backgroundfullfinall.png" id="ground2" alt="grond illustratie" />
